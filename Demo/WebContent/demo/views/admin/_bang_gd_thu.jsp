...
<div id="deal" style="background: #E0E0E0;" >
     ...
     <div style="float: left">
    	<form method = "POST" action="${pageContext.request.contextPath}/ad/insertCollection">
    	   <fieldset>
              <legend>Giao dịch</legend> 
    	        <label for="date">Ngày chi</label>
    	        <input type="date" name = "date" id="date" value="" required/>   	        
    	        <label for="revenues">Nguồn thu</label>
    	        <input type="text" name = "revenues" id="revenues" value="" maxlength="8" required/> <br />
    	        
    	        <label for="category">Danh mục</label>
    	        <input type="text" name="category" id="category" value="" maxlength="20" required/>
    	        
    	        <label for="price">Số tiền</label>
    	        <input type="number" name="price" id="price" min="0" max="1000000000"value="" required/> <br/>
