...
public class ForgetPassword extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
    	...
    	RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/demo/views/login/forget_password.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
              ...
              if(!email.isEmpty()) {
            	  ...
            	  RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/demo/views/login/formspree.jsp");
              	  dispatcher.forward(request, response);
